...
def bill_pres():
  st.header("Bill")
  st.subheader("Enter the Patient ID")
  ...
  st.table(result)
  st.subheader("Enter the Doctor's Fee")
  ...
  if but1:
    query2="INSERT INTO `PatientBill` (`Medicine_1`,`Medicine_2`,`Medicine_3`,`Cost_1`,`Cost_2`,`Cost_3`,`Doctor_Fees`,`Total`) VALUES (%s,%s,%s,%s,%s,%s,%s,%s);"
    cursor.execute(query2, (medicine_1,medicine_2,medicine_3,result3.get('MRP'),result4.get('MRP'),result5.get('MRP'),doc_fee,total))
